...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int index = -1;
        do {
            System.out.println("Which item did you purchase? No items purchased enter N/A:  ");
            item = input.nextLine();
            purchases.add(item);
        ...
        } while (!item.equalsIgnoreCase("N/A"));


        for (int i = 0; i < purchases.size() - 1; i++) {
            System.out.println("Purchased items: " + purchases.get(i));
